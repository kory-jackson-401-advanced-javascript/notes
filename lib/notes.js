...
class Notes  {
  ...
  async list(command) {
    ...
    // let allNotes = await Note.find(allNotes.category);
    // console.log(allNotes)
    // let categoryArr = allNotes.category;
    // if ( command.category ) {
    //   allNotes = categoryArr.filter(item => {
    //     console.log(item[1], 'I am the item inside list')
